    ...
    <div class="min-h-screen bg-[radial-gradient(circle_at_10%_10%,#fecaca_0%,#ffffff_45%,#fef2f2_100%)] text-neutral-900">
      <header class="border-b border-red-100 bg-white/90 backdrop-blur">
        <div class="mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-4 md:px-8">
          ...
          <nav class="hidden gap-6 text-sm font-semibold md:flex">
            <a routerLink="/about" class="transition hover:text-red-600">A propos</a>
            <a routerLink="/programs" class="transition hover:text-red-600">UE & parcours</a>
            <a routerLink="/admissions" class="transition hover:text-red-600">Admissions</a>
            <a routerLink="/admin-space" class="transition text-red-700">Admin</a>
            <a routerLink="/contact" class="rounded-full bg-red-600 px-4 py-2 text-white transition hover:bg-black">Contact</a>
          </nav>
        </div>
      </header>
      ...
      <main class="mx-auto w-full max-w-6xl space-y-8 px-4 py-10 md:px-8">
        ...
        <section class="grid gap-6 md:grid-cols-2">
          <a routerLink="/admin" class="group rounded-2xl border border-red-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
          ...
          <a routerLink="/admin/ues" class="group rounded-2xl border border-red-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
            <h2 class="text-2xl font-bold text-black">CRUD UE</h2>
            <p class="mt-3 text-neutral-700">Ajouter, modifier, consulter et supprimer les UE disponibles pour l'affectation des etudiants.</p>
            <p class="mt-4 text-sm font-semibold text-red-700 group-hover:text-black">Ouvrir le module</p>
          </a>
        </section>
      </main>
